  ...
  return (
    <section className="section-three">
      <div className="section-three-content">
        <h1 className="section-three-title">Why Invest with Wealth wise portfolios?</h1>
        <p className="section-three-description">
          Discover how Wealth wise portfolios makes your investments smarter and safer with
        ...
        <div className="section-three-cards">
          ...
          <div className="card">
            ...
            <p className="card-text">
              Unlock new avenues for financial growth with Wealth wise portfolios.
            </p>
          </div>
        </div>
      </div>
